...
const DYNAMIC_KEY_ALLOWLIST: ReadonlyArray<string> = [
  ...
  'elements:elements.patanDurbar.title',
  'elements:elements.patanDurbar.oneLine',
  'elements:elements.patanDurbar.context',
  'elements:elements.bhaktapurDurbar.title',
  'elements:elements.bhaktapurDurbar.oneLine',
  'elements:elements.bhaktapurDurbar.context',
  'elements:elements.newariWindow.title',
  'elements:elements.newariWindow.oneLine',
  'elements:elements.newariWindow.context',
  'elements:elements.torana.title',
  'elements:elements.torana.oneLine',
  'elements:elements.torana.context',
  'elements:elements.prayerWheel.title',
  'elements:elements.prayerWheel.oneLine',
  'elements:elements.prayerWheel.context',
  'elements:elements.bell.title',
  'elements:elements.bell.oneLine',
  'elements:elements.bell.context',
  'elements:elements.diyo.title',
  'elements:elements.diyo.oneLine',
  'elements:elements.diyo.context',
